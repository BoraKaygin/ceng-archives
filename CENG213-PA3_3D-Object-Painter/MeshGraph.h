...
class MeshGraph
{
    ...
    void ShortestPath(int vertexIdFrom,std::vector<double> &distance, std::vector<int> &previous) const;
    double FilterFunction(double alpha,double distance, FilterType type) const;
